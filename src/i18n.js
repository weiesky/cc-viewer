const i18nData = {
  ...
  "ui.terminal.noPermission": {
    "zh": "终端访问被拒绝，当前没有操作终端的权限",
    "en": "Terminal access denied. You do not have permission to use the terminal.",
    "zh-TW": "終端存取被拒絕，目前沒有操作終端的權限",
    "ko": "터미널 접근이 거부되었습니다. 터미널 사용 권한이 없습니다.",
    "ja": "ターミナルへのアクセスが拒否されました。ターミナルを使用する権限がありません。",
    "de": "Terminalzugriff verweigert. Sie haben keine Berechtigung, das Terminal zu verwenden.",
    "es": "Acceso al terminal denegado. No tiene permiso para usar el terminal.",
    "fr": "Accès au terminal refusé. Vous n'avez pas la permission d'utiliser le terminal.",
    "it": "Accesso al terminale negato. Non hai il permesso di usare il terminale.",
    "da": "Terminaladgang nægtet. Du har ikke tilladelse til at bruge terminalen.",
    "pl": "Odmowa dostępu do terminala. Nie masz uprawnień do korzystania z terminala.",
    "ru": "Доступ к терминалу запрещён. У вас нет разрешения на использование терминала.",
    "ar": "تم رفض الوصول إلى الطرفية. ليس لديك إذن لاستخدام الطرفية.",
    "no": "Terminaltilgang nektet. Du har ikke tillatelse til å bruke terminalen.",
    "pt-BR": "Acesso ao terminal negado. Você não tem permissão para usar o terminal.",
    "th": "การเข้าถึงเทอร์มินัลถูกปฏิเสธ คุณไม่มีสิทธิ์ใช้งานเทอร์มินัล",
    "tr": "Terminal erişimi reddedildi. Terminali kullanma izniniz yok.",
    "uk": "Доступ до терміналу заборонено. У вас немає дозволу на використання терміналу."
  },
  "ui.terminal.needLogin": {
    "zh": "请先登录后再访问终端",
    "en": "Please log in first to access the terminal.",
    "zh-TW": "請先登入後再存取終端",
    "ko": "터미널에 접근하려면 먼저 로그인하세요.",
    "ja": "ターミナルにアクセスするには、まずログインしてください。",
    "de": "Bitte melden Sie sich zuerst an, um auf das Terminal zuzugreifen.",
    "es": "Inicie sesión primero para acceder al terminal.",
    "fr": "Veuillez vous connecter d'abord pour accéder au terminal.",
    "it": "Effettua l'accesso per accedere al terminale.",
    "da": "Log venligst ind først for at få adgang til terminalen.",
    "pl": "Zaloguj się najpierw, aby uzyskać dostęp do terminala.",
    "ru": "Пожалуйста, сначала войдите в систему для доступа к терминалу.",
    "ar": "يرجى تسجيل الدخول أولاً للوصول إلى الطرفية.",
    "no": "Vennligst logg inn først for å få tilgang til terminalen.",
    "pt-BR": "Faça login primeiro para acessar o terminal.",
    "th": "กรุณาเข้าสู่ระบบก่อนเพื่อเข้าถึงเทอร์มินัล",
    "tr": "Terminale erişmek için lütfen önce giriş yapın.",
    "uk": "Будь ласка, спочатку увійдіть для доступу до терміналу."
  },
  "ui.terminal.goLogin": {
    "zh": "前往登录",
    "en": "Go to Login",
