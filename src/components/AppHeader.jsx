              ...
              <Button
                ...
                icon={
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style={{ verticalAlign: 'middle' }}>
                    <rect x="2" y="2" width="4" height="4"/><rect x="8" y="2" width="2" height="2"/><rect x="2" y="8" width="2" height="2"/>
                    <rect x="6" y="2" width="2" height="2" fill="none"/><rect x="2" y="6" width="4" height="2" fill="none"/>
                    <path d="M2 2h8v8H2V2zm2 2v4h4V4H4zM14 2h8v8h-8V2zm2 2v4h4V4h-4zM2 14h8v8H2v-8zm2 2v4h4v-4H4z"/>
                    <rect x="14" y="14" width="2" height="2"/><rect x="18" y="14" width="4" height="2"/><rect x="14" y="18" width="2" height="4"/><rect x="18" y="18" width="2" height="2"/><rect x="20" y="20" width="2" height="2"/>
                    <rect x="12" y="12" width="2" height="2"/><rect x="12" y="16" width="2" height="2"/>
                  </svg>
                }
              />
            </Popover>
