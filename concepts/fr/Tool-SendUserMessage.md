...
- Activé uniquement en mode brief ou via le déploiement de fonctionnalité correspondant ; la plupart des sessions CLI interactives s'adressent directement à l'utilisateur à la place.
