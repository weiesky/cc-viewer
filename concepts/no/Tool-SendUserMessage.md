...
- Skjult i interaktive sesjoner som standard; de fleste interaktive CLI-sesjoner snakker med brukeren direkte i stedet.
- Aktivert i brief-modus eller via server-side feature-flags.
