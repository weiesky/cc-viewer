...
- ซ่อนในเซสชันแบบ interactive ตามค่าเริ่มต้น เซสชัน CLI แบบ interactive ส่วนใหญ่คุยกับผู้ใช้โดยตรงแทน
- เปิดใช้งานใน brief mode หรือผ่าน feature flag ฝั่ง server
