...
Автоматичне оновлення слідує глобальній конфігурації Claude Code у `~/.claude/settings.json`. Якщо в Claude Code автоматичні оновлення вимкнено (`autoUpdates: false`), CC-Viewer також пропустить автоматичне оновлення.
