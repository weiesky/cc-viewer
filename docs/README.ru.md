...
```
Я установил npm-пакет cc-viewer, но не могу его запустить. Посмотри cli.js и findcc.js в cc-viewer, и адаптируй их под локальный способ развёртывания Claude Code с учётом текущей ситуации. Старайся ограничить область изменений файлом findcc.js.
```
