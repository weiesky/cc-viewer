...
```
cc-viewer という npm パッケージをインストールしましたが、起動できません。cc-viewer の cli.js と findcc.js を確認し、具体的な状況に応じてローカルの claude code のデプロイ方式に適応してください。適応の際は、変更範囲をできるだけ findcc.js 内に限定してください。
```
