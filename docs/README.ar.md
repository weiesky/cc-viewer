...
```
لقد قمت بتثبيت حزمة npm الخاصة بـ cc-viewer، لكن لا يمكنني تشغيلها. راجع cli.js وfindcc.js الخاصين بـ cc-viewer، وقم بتكييف طريقة نشر claude code المحلية بناءً على الظروف الفعلية. حاول تقييد نطاق التعديلات في findcc.js قدر الإمكان.
```
