...
يوفر cc-viewer نسخة عميل سطح المكتب، يمكنك تحميل النسخة المناسبة من GitHub.
[رابط التحميل](https://github.com/weiesky/cc-viewer/releases)
نسخة العميل حاليًا في مرحلة الاختبار، إذا واجهت أي مشاكل يمكنك تقديم ملاحظاتك في أي وقت. كما أن الشرط الأساسي لاستخدام cc-viewer هو أن يكون Claude Code مثبتًا على جهازك المحلي.
تجدر الإشارة إلى أن cc-viewer هو مجرد "ثوب" للعامل (Claude Code)، بدون Claude Code لا يمكن لهذا الثوب أن يعمل بمفرده.
...
**الإدخال الصوتي**: انقر على أيقونة الميكروفون في مربع الدردشة لتحويل الكلام إلى نص (Web Speech API؛ يتطلب HTTPS أو localhost، لذا يتم إخفاء الزر عند الوصول عبر LAN HTTP). على Android استخدم مفتاح 🎤 المدمج في لوحة مفاتيح Gboard، وعلى iOS استخدم الإملاء النظامي على لوحة المفاتيح — كلاهما يعمل دون اتصال ودون الحاجة إلى HTTPS.
