...
* **พรีเซ็ตในตัวมีผลโดยค่าเริ่มต้น:** แพ็กเกจมาพร้อมพรอมต์ที่ปรับแต่งแล้วสำหรับ `deepseek-v4-pro`, `deepseek-v4-flash`, `GLM-5.2`, `Qwen-3.7-Max`, `kimi-k2.7-code` และ `kimi-k3` — เมื่อโมเดลที่แปลงมาตรงกับตัวใดตัวหนึ่งและไม่มีรายการของคุณตรงกัน พรอมต์ในตัวจะถูกฉีดโดยอัตโนมัติ (ไฟล์ของคุณชนะเสมอ: เวิร์กสเปซ > ส่วนกลาง > ในตัว) แท็บในตัวมีป้าย **ในตัว** ในโมดัล: แก้ไขและบันทึกเพื่อสร้างรายการแทนที่ของคุณ หรือใช้ × ของแท็บเพื่อ **ปิดใช้งาน** รายการในตัว (บันทึกใน `<scope>/system_prompt/.builtin-disabled.json`) รายการในตัวที่ถูกปิดใช้งานจะกลับไปใช้ไฟล์ค่าเริ่มต้น และรายการในส่วนหัวยังคงมองเห็นโดยทำเครื่องหมายว่า "ปิดใช้งานแล้ว" เพื่อให้คุณเปิดใช้งานใหม่ได้ทุกเมื่อ
