...
* ข้อความ system จะตามการสลับโมเดลหลักแบบ hot ระหว่างเซสชัน ตรึงไว้ต่อ (เซสชัน, โมเดล) (KV-cache ถูกทำลายเพียงครั้งเดียวตอนสลับ) การบันทึกแท็บว่างจะลบรายการนั้น ตั้งค่า `CCV_DISABLE_AUTO_SYSTEM_PROMPT=1` เพื่อปิดการฉีดอัตโนมัติทั้งหมด
