...
```
ฉันได้ติดตั้งแพ็กเกจ npm ชื่อ cc-viewer แล้ว แต่ไม่สามารถเริ่มต้นได้ ให้ตรวจสอบ cli.js และ findcc.js ของ cc-viewer แล้วปรับให้เข้ากับวิธีการติดตั้ง Claude Code ในเครื่องตามสถานการณ์จริง โดยพยายามจำกัดขอบเขตการแก้ไขไว้ที่ findcc.js เท่าที่เป็นไปได้
```
