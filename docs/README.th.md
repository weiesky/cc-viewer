...
CC-Viewer ตรวจสอบการอัปเดตอัตโนมัติเมื่อเริ่มต้น (สูงสุดทุก 4 ชั่วโมง) ภายในเวอร์ชันหลักเดียวกัน (เช่น 1.x.x → 1.y.z) การอัปเดตจะถูกนำไปใช้โดยอัตโนมัติและมีผลเมื่อเริ่มต้นใหม่ การเปลี่ยนเวอร์ชันหลักจะแสดงเฉพาะการแจ้งเตือน
