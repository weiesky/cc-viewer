...
* The system text follows hot-switched main models mid-session, pinned per session+model (KV-cache busted once at the switch). Saving a tab empty deletes the entry. Set `CCV_DISABLE_AUTO_SYSTEM_PROMPT=1` to disable all auto-injection.
