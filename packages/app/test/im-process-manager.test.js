...
const { imDir, acquireImLock, updateImLockPort, readImLock, clearImLock } = await import('../server/lib/im/im-lock.js');
const {
  buildChildEnv, spawnImProcess, stopImProcess, getImProcessStatus, reconcileImProcesses,
} = await import('../server/lib/im/im-process-manager.js');
