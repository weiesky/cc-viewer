...
describe('presets', () => {
  ...
  it('the manifest lists the seven expected [Global] presets', () => {
    ...
    assert.deepEqual(ids, ['GLM-5.2', 'GLM-5.3', 'Qwen-3', 'deepseek-v4-flash', 'deepseek-v4-pro', 'kimi-k2.7-code', 'kimi-k3']);
  });

  for (const preset of [{ id: 'deepseek-v4-pro' }, { id: 'deepseek-v4-flash' }, { id: 'GLM-5.2' }, { id: 'GLM-5.3' }, { id: 'Qwen-3' }, { id: 'kimi-k2.7-code' }, { id: 'kimi-k3' }]) {
