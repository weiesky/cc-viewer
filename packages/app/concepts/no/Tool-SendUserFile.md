...
- Kun tilgjengelig når en Remote Control-klient er tilkoblet, eller sesjonen kjører i et administrert cloud-miljø (f.eks. Claude Code on the web).
- Ikke tilgjengelig på Amazon Bedrock, Google Cloud eller Microsoft Foundry.
