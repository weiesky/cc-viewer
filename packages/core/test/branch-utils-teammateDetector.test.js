// Branch coverage for @ccv/core/teammateDetector (packages/core/src/teammateDetector.js)
//
...
//
// Core modules are plain ESM (all imports carry .js extensions) — no vite-loader
// shim needed; dynamic import() below is a style choice, not a requirement.
...
before(async () => {
  const mod = await import('../src/teammateDetector.js');
