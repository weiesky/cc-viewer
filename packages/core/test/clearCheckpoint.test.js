/**
 * Unit tests for @ccv/core/clearCheckpoint (packages/core/src/)
 * Direct branch coverage for isPostClearCheckpoint(entry, prevMessageCount).
 */
import { describe, it } from 'node:test';
import assert from 'node:assert/strict';
import { isPostClearCheckpoint, isCompactContinuation, isSessionBoundary } from '../src/clearCheckpoint.js';
