// CLIENT-SAFE: no node deps. Home: @ccv/core (voice-pack-events.js) — consumed by apps/web + packages/app. Do not add fs/process/node: imports.
...
// 老用户 preferences.json 含这两个 key 由 ./approval-modal-prefs.js（@ccv/core）_filterEvents 白名单
