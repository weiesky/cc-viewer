// CLIENT-SAFE: no node deps. Home: @ccv/core (session-boundary.js) — consumed by apps/web + packages/app. Do not add fs/process/node: imports.
...
//  - client: ./clearCheckpoint.js (sibling re-export shell), apps/web's
//    sessionMerge.js, sessionManager.js, entry-slim.js, ./contentFilter.js
