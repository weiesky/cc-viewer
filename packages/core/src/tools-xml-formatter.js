// CLIENT-SAFE: no node deps. Home: @ccv/core (tools-xml-formatter.js) — consumed by apps/web + packages/app. Do not add fs/process/node: imports.
/**
 ...
 *
 * Single source of truth: apps/web/src/utils/toolsXmlFormatter.js re-exports
 * from here (via @ccv/core), server/lib/kv-cache-analyzer.js imports from here.
 *
