...
const KEYS = [
  ...
  // 内置 preset 页签(built-in default-effective model prompts + 墓碑禁用)
  'ui.expert.systemText.scopeBuiltin',
  'ui.expert.systemText.builtinDisableConfirm',
  'ui.expert.systemText.builtinEnableConfirm',
  'ui.expert.systemText.builtinDisabledBadge',
  'ui.expert.systemText.builtinEditHint',
  'ui.expert.systemText.builtinShadowed',
  'ui.expert.systemText.builtinDirHint',
  'ui.expert.systemText.builtinDisabledHint',
