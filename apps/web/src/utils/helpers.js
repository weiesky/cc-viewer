...
export { getEffectiveModel } from './effectiveModel.js';
...
const MODEL_PROVIDERS = [
  {
    ...
    svg: `<svg t="1771495509570" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1570" width="200" height="200"><path d="${CLAUDE_STARBURST_PATH}" fill="#D97757" p-id="1571"></path></svg>`,
...
export function getSvgAvatar(type) {
  ...
  // system: Claude starburst logo (official brand color #D97757) for mid-conversation
  // role:"system" messages — the "Append System Prompt" meta rows and their role-filter chip.
  // Shares the path with MODEL_PROVIDERS' Claude entry above.
  if (type === 'system') {
    return `<svg viewBox="0 0 1024 1024"><path d="${CLAUDE_STARBURST_PATH}" fill="#D97757"/></svg>`;
  }
