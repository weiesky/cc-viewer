// Re-export shell — the implementation moved VERBATIM to @ccv/core/error-report
...
export { reportSwallowed, MAX_REPORTS_PER_TAG, _resetForTest } from '@ccv/core/error-report';
