 ...
 * Other keys are ignored — producers with extended metadata should write session.json themselves.
 */
 ...
 * No-op (returns false) if env absent; returns true without touching the file if it already exists (resume case).
 */
